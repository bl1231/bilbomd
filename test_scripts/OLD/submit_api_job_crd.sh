...
CRD_FILE="$SCRIPT_DIR/data/crd/pro_dna.crd"
PSF_FILE="$SCRIPT_DIR/data/crd/pro_dna.psf"
DAT_FILE="$SCRIPT_DIR/data/crd/saxs-data.dat"
INP_FILE="$SCRIPT_DIR/data/crd/const.inp"
