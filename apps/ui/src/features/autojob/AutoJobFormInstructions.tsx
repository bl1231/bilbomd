      ...
      <AccordionDetails>
        <Box>
          <Typography sx={{ m: 1 }}>
            ...
            files. The <b>*.pdb</b> and PAE <b>*.json</b> files must be the
            exact ones obtained from AlphaFold since we are also using the{' '}
            <Link
          ...
          <ul>
            <li>
              <Typography>
                An AlphaFold PDB <b>*.pdb</b> file (PDB coordinate file. Make
                sure it matches your PAE file.)
              </Typography>
            </li>
            <li>
              <Typography>
