    ...
    <>
      ...
      <Grid size={8}>
        ...
        >
          ...
          DM, Karplus M. <b>CHARMM: the biomolecular simulation program.</b> J
          Comput Chem. 2009 Jul 30;30(10):1545-614. doi: 10.1002/jcc.21287.
          PMID:{' '}
          <Link
        ...
        <Typography
          ...
          sx={{ mx: 2, my: 2 }}
        >
          Eastman P, Galvelis R, Peláez RP, Abreu CRA, Farr SE, Gallicchio E,
          Gorenko A, Henry MM, Hu F, Huang J, Krämer A, Michel J, Mitchell JA,
          Pande VS, Rodrigues JP, Rodriguez-Guerra J, Simmonett AC, Singh S,
          Swails J, Turner P, Wang Y, Zhang I, Chodera JD, De Fabritiis G,
          Markland TE.{' '}
          <b>
            OpenMM 8: Molecular Dynamics Simulation with Machine Learning
            Potentials.
          </b>{' '}
          J. Phys. Chem. B 128(1), pp. 109-116 (2023). doi:
          10.1021/acs.jpcb.3c06662. Epub 2023 Dec 28. PMID:{' '}
          <Link
            href="https://pubmed.ncbi.nlm.nih.gov/38154096/"
            target="_blank"
            rel="noopener noreferrer"
          >
            38154096
