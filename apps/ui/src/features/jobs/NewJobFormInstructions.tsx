  ...
  return (
    ...
    >
      ...
      <AccordionDetails>
        ...
        <Typography sx={{ mx: 1, my: 2 }}>
          Use <b>BilboMD Classic</b> if you want more control over the inputs.
          For example, if you have DNA, RNA, or other ligands and
        ...
        <Accordion>
          ...
          <Alert severity="warning">
            ...
            <Typography sx={{ mx: 1, my: 2 }}>
              ...
              <b>segid</b> names in your CRD file match the <b>segid</b> names
              in you <b>const.inp</b> file. This is because CHARMM-GUI uses{' '}
              ...
              segid <b>PROA</b> and the second protein chain as segid{' '}
              <b>PROB</b> etc. even if the original chain IDs were something
              other than A and B.
            </Typography>
          </Alert>
        </Accordion>
        <Accordion sx={{ mt: 2 }}>
          ...
          <Typography sx={{ mx: 1, my: 2 }}>
            ...
            will convert your PDB file to the required CRD and PSF files.
            However, we do this slightly differently than CHARMM-GUI. The main
            difference is the way we rename the chains for input to CHARMM.
            Essentially we retain your original chain IDs wheras CHARMM-GUI
            renames the first Protein chain as segid <b>PROA</b>, the second
            Protein chain as segid <b>PROB</b>,{' '}
        ...
        <Typography sx={{ mx: 1, my: 2 }}>
          <b>Conformations per Rg</b> - Specify the number of atomic models to
          be calculated for each Rg Step (Radius of Gyration - explanation
          below). More models will increase the conformational space sampled at
          the expense of slightly longer computational times.
        </Typography>
        <Typography sx={{ mx: 1, my: 2 }}>
          <b>Rg Steps</b> - Define the Radius of Gyration range (as{' '}
          <b>Rg Min</b> and <b>Rg Max</b>) that will constrain the MD
          simulations. <b>BilboMD</b> will calculate 5 equidistant steps bewteen{' '}
          <b>Rg Min</b> and <b>Rg Max</b> to perform Molecular Dynamics. A good
          rule-of-thumb for your initial <b>BilboMD Classic</b> run is to select
          initial <b>Rg Min</b> and <b>Rg Max</b> values from -7% to +25% around
          your experimental Rg respectively. If your experimental Rg is 25-30
          &#8491;, the MD simulations can behave eradically if you specify an{' '}
          <b>Rg Min</b> that is too small. This is why we recommend{' '}
          <b>Rg Min</b> to be ~ 7% less than your experimental Rg. However, if
          your experimental Rg is larger (e.g. &gt;50 &#8491;) then you can
          probably explore a wider range and pick <b>Rg Min</b> and{' '}
