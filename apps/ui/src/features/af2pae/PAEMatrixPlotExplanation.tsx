...
const PAEMatrixPlotExplanation = () => {
  return (
    <Box sx={{ ml: 3 }}>
          ...
          <ListItemText
            primary={
              <>
                ...
                <ColorBox color={paeColors[1]} /> → the model is confident about
                their relative orientation (AlphaFold “thinks” they pack
          ...
          <ListItemText
            primary={
              <>
                ...
                <ColorBox color={paeColors[4]} /> → AlphaFold is uncertain about
                how those domains/chains are arranged relative to one another;
                they might float or hinge.
              </>
            }
          />
        </ListItem>
      ...
      <Typography variant="body1">
        <strong>Single-chain, multi-domain proteins:</strong> off-diagonal tells
        you whether AlphaFold is confident about domain packing.
      </Typography>
      <List
        sx={{
          listStyleType: 'disc',
      ...
      <Typography variant="body1">
        <strong>Multimer predictions:</strong> off-diagonal between chains tells
        you if the relative placement of chains is trustworthy.
      </Typography>
      <List
        sx={{
          listStyleType: 'disc',
